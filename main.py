...
from prepare_data import load_file, load_sample, split_samples
...
for i in train_samples:
    sample_x, sample_y = load_sample(main_path+paths[i], names[i], labels[i], sampling_rates[i], dimension1=features_dim1, dimension2=features_dim2, train=True)
    print('yep1 %d'%i)
...
model.save_weights('new_calssification1_0.h5')
